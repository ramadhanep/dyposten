    ...
    <section class="section">
        ...
        <div class="col-lg-4">
            ...
            <div class="card-body" id="top-5-scroll">
                ...
                <li class="media">
                    <img class="mr-3 rounded" width="55" src="{{ asset('stisla/img/products/product-3-50.png') }}" alt="product">
                ...
                <li class="media">
                    <img class="mr-3 rounded" width="55" src="{{ asset('stisla/img/products/product-4-50.png') }}" alt="product">
                    <div class="media-body">
                ...
                <li class="media">
                    <img class="mr-3 rounded" width="55" src="{{ asset('stisla/img/products/product-1-50.png') }}" alt="product">
                    <div class="media-body">
                ...
                <li class="media">
                    <img class="mr-3 rounded" width="55" src="{{ asset('stisla/img/products/product-5-50.png') }}" alt="product">
                    <div class="media-body">
            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="product-image">
                        <img alt="image" src="{{ asset('stisla/img/products/product-4-50.png') }}" class="img-fluid">
                    </div>
                ...
                <div>
                    ...
                    <div class="product-image">
                        <img alt="image" src="{{ asset('stisla/img/products/product-3-50.png') }}" class="img-fluid">
                    </div>
                    <div class="product-details">
                ...
                <div>
                    <div class="product-item">
                    <div class="product-image">
                        <img alt="image" src="{{ asset('stisla/img/products/product-1-50.png') }}" class="img-fluid">
                    </div>
                    <div class="product-details">
        ...
        <div class="col-md-6">
            ...
            <div class="card-body">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="media">
                        <img class="img-fluid mt-1 img-shadow" src="{{ asset('stisla/modules/flag-icon-css/flags/4x3/id.svg') }}" alt="image" width="40">
                    ...
                    <li class="media">
                        <img class="img-fluid mt-1 img-shadow" src="{{ asset('stisla/modules/flag-icon-css/flags/4x3/my.svg') }}" alt="image" width="40">
                        <div class="media-body ml-3">
                    ...
                    <li class="media">
                        <img class="img-fluid mt-1 img-shadow" src="{{ asset('stisla/modules/flag-icon-css/flags/4x3/us.svg') }}" alt="image" width="40">
                        <div class="media-body ml-3">
                ...
                <div class="col-sm-6 mt-sm-0 mt-4">
                    ...
                    <li class="media">
                        <img class="img-fluid mt-1 img-shadow" src="{{ asset('stisla/modules/flag-icon-css/flags/4x3/ps.svg') }}" alt="image" width="40">
                        <div class="media-body ml-3">
                    ...
                    <li class="media">
                        <img class="img-fluid mt-1 img-shadow" src="{{ asset('stisla/modules/flag-icon-css/flags/4x3/de.svg') }}" alt="image" width="40">
                        <div class="media-body ml-3">
